...
@Component({
  selector: 'app-treasure-dividend-three',
  templateUrl: './treasure-dividend-three.component.html',
  styleUrls: ['./treasure-dividend-three.component.css']
})
export class TreasureDividendThreeComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    setTimeout(async () => {
      ...
      const result = await this.treasureManager.getPowerDividends(today, 7);
